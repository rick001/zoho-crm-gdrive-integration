...
/**
 * Debug token exchange with the local authorization code
 */
async function debugLocalToken() {
  console.log('🔍 Debugging Local Token Exchange');
  console.log('==================================\n');

  const authCode = '1000.f4b7de32da18b0c7e1d993510ed86433.5cd8ec1ee8cd5d59158509d6c1bff526';
...
debugLocalToken().catch(console.error); 